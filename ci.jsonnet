{
  ...
  local graalvmBuild = {
    ...
    run+: [
      ...
      ['mvn', 'package'],
      ['./sl', 'language/tests/Add.sl'],
      ['./native/graaljulia-native', 'language/tests/Add.sl'],
      ["$JAVA_HOME/bin/gu", 'install', '-L', 'component/graaljulia-component.jar'],
      ["$JAVA_HOME/bin/sl", 'language/tests/Add.sl'],
      ["$JAVA_HOME/bin/graaljulia-native", 'language/tests/Add.sl'],
